...
export interface AltScenarioMethods extends AltMethods {
...
export interface Alt extends Contract {
  methods: AltMethods;
  name: string;
}

export interface AltScenario extends Contract {
  methods: AltScenarioMethods;
  name: string;
}

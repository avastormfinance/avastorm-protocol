...
/**
  * @title Avastorm's DAIInterestRateModel Contract (version 3)
  * @author Avastorm (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original Avastorm Protocol whitepaper.
